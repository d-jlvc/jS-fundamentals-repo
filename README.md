### --1. Project overview:
Hello! This is an e-commerce project simulating a business. I am presenting my first ever try to create a web-page in this field. Hopefully, this repo will be a testament to my personal growth.
...
```
    ...
    - index.html: overall project legend
    - page-checkout.html
    - page-login.html
    - page-product.html
